      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="breadcrumb__content p-relative z-index-1">
            ...
            <div class="breadcrumb__list"></div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-6 col-lg-8">
          <div class="tp-login-wrapper">
            <div class="tp-login-top text-center mb-30">
              <h3 class="tp-login-title">Login to {{\App\Helpers\Helpers::get_option('app_name')}}.</h3>
              <p>Don’t have an account? <span><a href="{{route('register')}}">Create a free account</a></span></p>
            </div>
            <form id="adminLogin" method="POST" action="{{ route('login') }}" >
              @csrf
              <div class="tp-login-option">
                <div class="tp-login-input-wrapper">
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input type="text" id="email" name="email" value="{{old('email')}}" placeholder="info@mail.com" autofocus>
                    </div>
                    <div class="tp-login-input-title">
                      <label for="email">Your Phone or Email</label>
                  ...
                  <div class="tp-login-input-box">
                    ...
                    <div class="tp-login-input-eye" id="password-show-toggle">
                                    <span id="open-eye" class="open-eye" style="display: none;">
                      ...
                      <span id="close-eye" class="open-close" style="display: block;">
                ...
                <div class="tp-login-bottom">
                  <button class="tp-login-btn w-100" type="submit">Login</button>
                </div>
              </div>
            </form>
          </div>
