        ...
        <div class="col-xl-6 col-lg-8">
          <div class="tp-login-wrapper">
            <div class="tp-login-top text-center mb-30">
              <h3 class="tp-login-title">Sign Up {{\App\Helpers\Helpers::get_option('app_name')}}.</h3>
            ...
            <form id="adminLogin" method="POST" action="{{ route('register') }}" >
              @csrf
              <div class="tp-login-option">
                <div class="tp-login-input-wrapper">
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input id="name" name="name" value="{{old('name')}}" type="text" placeholder="Enter your name">
                  ...
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input id="email" type="email" value="{{old('email')}}"  name="email" placeholder="info@mail.com">
                  ...
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                      <input id="mobile" name="mobile" value="{{old('mobile')}}"  type="text" placeholder="Enter your phone">
                      <x-input-error  :messages="$errors->get('mobile')" class="mt-2" />
                    </div>
                    <div class="tp-login-input-title">
                      <label for="mobile">Your Phone <span class="text-danger">*</span></label>
                    </div>
                  </div>
                  <div class="tp-login-input-box">
                    <div class="tp-login-input">
                    ...
                    <div class="tp-login-input-title">
                      <label for="tp_password">Password <span class="text-danger">*</span></label>
                    </div>
                  </div>
                </div>
                ...
                <div class="tp-login-bottom">
                  <button class="tp-login-btn w-100" type="submit">Sign Up</button>
                </div>
              </div>
            </form>
          </div>
