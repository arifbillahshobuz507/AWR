                    ...
                    <div class="hero-content">
                     <div class="text-center mb-3">
                        ...
                        <div class="mb-3 icon-group">
                            ...
                            <span class="icon-inside"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 940 610">
                                    <path fill="gray"
                        ...
                        <div class="mb-3 icon-group">
                            ...
                            <span class="icon-inside"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1040 610">
                                    <path fill="gray"
