                                        ...
                                        <div class="col-11">
                                            <div class="content-sld_wrap">
                                                ...
                                                <h1 class="title_sld text-display fade-item fade-item-2">
                                                    <a href="product-detail.html" class="link fw-normal ">
                                                        Wireless Bluetooth <br class="d-none d-sm-block">
                                                        Over-Ear Headphones
                                                    </a>
                                                </h1>
                                    ...
                                    <div class="row">
                                        <div class="col-11">
                                            <div class="content-sld_wrap">
                                                ...
                                                <h1 class="title_sld text-display fade-item fade-item-2">
                                                    <a href="product-detail.html" class="link fw-normal ">
                                                        A14 Pro Max 5G <br class="d-none d-sm-block">
                                                        Unlocked Smartphone
                                                    </a>
                                                </h1>
                                                <div class="price-wrap price_sld fade-item fade-item-3">
                                    ...
                                    <div class="row">
                                        <div class="col-11">
                                            <div class="content-sld_wrap">
                                                ...
                                                <h1 class="title_sld text-display fade-item fade-item-2">
                                                    <a href="product-detail.html" class="link fw-normal ">
                                                        TP-Link Tapo 1080P <br class="d-none d-sm-block">
                                                        Indoor Security
                                                    </a>
                                                </h1>
                                                <div class="price-wrap price_sld fade-item fade-item-3">
    ...
    <div class="container">
                        ...
                        <a href="#" class="widget-collection style-circle hover-img">
                            ...
                            <div class="collection_image img-style">
                                @if($category->image)
                                    <img class="lazyload"
                                        ...
                                        alt="{{ $category->name }}">
                                @else
                                    <!-- Default image if no category image -->
                                    <img class="lazyload"
                                        src="{{ asset('userInterface/images/category/default-category.jpg') }}"
                                        data-src="{{ asset('userInterface/images/category/default-category.jpg') }}"
                                        alt="{{ $category->name }}">
                                @endif
                            </div>
                            <p class="collection_name h4 link">
                                ...
                                @if($category->products_count)
                                    <span class="count text-main-2">({{ $category->products_count }})</span>
                                @else
                                    <span class="count text-main-2">(0)</span>
                                @endif
                            </p>
                        </a>
                    </div>
        ...
        @else
            <div class="text-center py-5">
                <p class="text-muted">No categories found. Add some categories from the admin panel.</p>
            </div>
        @endif
    </div>
</section>
